                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <%
                                    ...
                                    List<MProducto> listaProductos = obj.lisProductosMasCarosPorAnio(an);
                                %>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                                            ...
                                                            <tr><th>Producto</th><th>Precio</th></tr>
                                                                    <%
                                                                        for (MProducto producto : listaProductos) {
                                                                            out.print("<tr><td>" + producto.getNombre() + "</td><td>" + producto.getPrecioVenta() + "</td></tr>");
                                                                        }
                                                                    %>
                                                        </table>
                                                    </form>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="container">
                                                <h2>Productos más caros del año <%=an%></h2>     
                                            </div> 
                                ...
                                <%
                                    ...
                                    for (MProducto producto : listaProductos) {
                                        ...
                                        data.append(producto.getPrecioVenta()).append(",");
                                    }
                                    if (label.length() > 0) {
